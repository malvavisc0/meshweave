...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('visibility', 'domain', 'path', 'query', name='uq_crawls_vis_dom_path_query')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('crawl_id', 'page_url', 'email', name='uq_crawl_emails_unique')
    )
    op.create_index('ix_crawl_emails_crawl_id', 'crawl_emails', ['crawl_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['crawl_id'], ['crawls.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('crawl_id', 'page_url', 'absolute_url', 'type', name='uq_crawl_links_unique')
    )
