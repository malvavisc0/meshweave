...
Revision ID: 96bb2faad983
Revises:
Create Date: 2026-05-26 12:08:57.478077
"""
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_crawls_domain_is_latest", "crawls", ["domain", "is_latest"], unique=False
    )
