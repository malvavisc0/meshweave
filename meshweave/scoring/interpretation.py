...
_LENS_META: dict[LensName, dict[str, str]] = {
    "AEO": {
        ...
        "critical_label": "AI can't find your answers",
    ...
    "GEO": {
        ...
        "critical_label": "Not enough trust to recommend you",
        "primary_exposure": "AI won't recommend your website",
    ...
    "AAX": {
        ...
        "critical_label": "AI agents can't use your site",
        "primary_exposure": "Agents abandon your site before converting",
